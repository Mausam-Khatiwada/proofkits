...
export const metadata: Metadata = pageMetadata({
  ...
  description: 'Terms governing your use of ProofKit.',
  path: '/terms',
});
...
const terms = [
  {
    title: 'Service usage',
    body: 'By using ProofKit, you agree to use the platform only for lawful business purposes and in accordance with your customer commitments.',
  },
  {
  ...
  },
  {
    ...
    body: 'We continuously improve ProofKit and may update features, limits, or functionality while maintaining core service commitments.',
  },
  {
    title: 'Contact',
    ...
    <div className="bg-slate-50 text-slate-900 transition-colors duration-500 dark:bg-[#08070e] dark:text-white relative min-h-screen overflow-x-hidden">
      ...
      <main className="landing-fade-in mx-auto max-w-4xl px-4 py-14 sm:px-6 sm:py-20">
        ...
        <p className="mt-6 text-base leading-7 text-slate-600 dark:text-white/50">
          Effective date: April 15, 2026. These terms describe how ProofKit services are provided and used.
        </p>
