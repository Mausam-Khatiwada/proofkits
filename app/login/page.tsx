  ...
  return (
    <div className="bg-slate-50 text-slate-900 transition-colors duration-500 dark:bg-[#08070e] dark:text-white relative min-h-screen overflow-x-hidden flex flex-col">
      ...
      <header className="relative z-50 border-b border-slate-200 dark:border-white/[0.06]">
        <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-8" aria-label="Main">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link
              href="/signup"
              className="inline-flex items-center rounded-full border border-slate-200 px-3.5 py-2 text-sm font-semibold text-slate-800 transition-all hover:bg-slate-50 dark:border-white/12 dark:bg-white/[0.04] dark:text-white dark:hover:bg-white/[0.08] sm:px-5"
            >
              Sign up
            </Link>
          </div>
      ...
      <main className="landing-fade-in flex flex-1 items-start justify-center px-4 py-8 sm:items-center sm:py-12 sm:px-6">
        <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white/90 p-5 shadow-xl backdrop-blur-xl dark:border-white/[0.07] dark:bg-[#16132e]/85 dark:shadow-[0_24px_70px_rgba(88,28,135,0.35)] sm:p-8">
          <div className="mb-6 space-y-2">
            ...
            <h1 className="font-display text-[1.85rem] font-bold tracking-[-0.03em] text-slate-900 dark:text-white sm:text-3xl">Welcome back</h1>
          ...
          <div className="mt-7 space-y-4 text-center text-sm text-slate-500 dark:text-white/50 sm:mt-8">
            <p>
