...
const heroCards = [
  ...
  },
  {
    ...
    badge: null,
    content: {
      title: 'ProofKit helped us increase our conversion rate by 35%',
  ...
  },
  {
    ...
    content: {
      tag: 'Sentence Boost',
      quote:
        'ProofKit helped us increase our proof-our fever-a-est lat conesttimonials. "35%"',
      stars: 5,
      ...
      >
        <div className="rounded-2xl border border-white/10 bg-[#16132e]/85 p-5 shadow-[0_20px_60px_rgba(88,28,135,0.3)] backdrop-blur-xl">
          <p className="text-sm font-semibold leading-6 text-white">
            ProofKit helped us increase our conversion rate by <span className="text-violet-300">35%</span>
          </p>
        ...
        <div className="rounded-2xl border border-white/10 bg-[#16132e]/85 shadow-[0_24px_70px_rgba(88,28,135,0.35)] backdrop-blur-xl">
          ...
          <div className="p-4">
            ...
            <p className="text-sm leading-6 text-white/85">
              &ldquo;ProofKit helped us increase our proof-
              <br />
